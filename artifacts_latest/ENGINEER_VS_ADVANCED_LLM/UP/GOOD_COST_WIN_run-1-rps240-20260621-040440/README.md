...
- **RPS**: 240 (UP)
- **Source archive**: /Users/svastik/Documents/Svastik/github/microservices-stress-test-llm-analysis/artifacts_latest/FORMULA_VS_ADVANCED_LLM/UP/GOOD_COST_WIN_run-1-rps240-20260609-192356
- **Advanced subdir**: llm-run (formula llm-run = advanced LLM)
- **Engineer verify**: PASS 1×173m/32Mi prov_cost=0.4765
- **Advanced best_pass prov_cost**: 0.2442
