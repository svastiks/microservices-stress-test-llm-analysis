...
- **RPS**: 220 (UP)
- **Source archive**: /Users/svastik/Documents/Svastik/github/microservices-stress-test-llm-analysis/artifacts_latest/FORMULA_VS_ADVANCED_LLM/UP/GOOD_COST_WIN_run-1-rps220-20260609-134951
- **Advanced subdir**: llm-run (formula llm-run = advanced LLM)
- **Engineer verify**: PASS 1×129m/57Mi prov_cost=0.1217
- **Advanced best_pass prov_cost**: 0.2493
- **Advanced wins cost**: False
